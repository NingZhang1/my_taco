...
namespace taco
{
  namespace test
  {
    ...
    ostream &operator<<(ostream &os, const Formats &formats)
    {
      ...
      {
        os << endl
           << "  " << format.first.getName() << " : " << format.second;
      }
      return os << endl;
    }
    ...
    static map<TensorVar, TensorVar> formatVars(const std::vector<TensorVar> &vars,
  ...
  INSTANTIATE_TEST_CASE_P(name, lower,                 \
    ...
    TEST_STMT(vector_div,
              ...
              {TestCase({{b, {{{0}, 2.0}, {{1}, 1.0}, {{3}, 6.0}}},
                         {c, {{{0}, 1.0}, {{1}, 2.0}, {{2}, 3.0}, {{3}, 4.0}, {{4}, 5.0}}}},
                        {{a, {{{0}, 2.0}, {{1}, 0.5}, {{3}, 1.5}}}})})
    ...
    TEST_STMT(matrix_vector_mul,
              ...
              Values(
                  Formats({{a, Format({dense})},
                           {B, Format({dense, dense})},
                           {c, Format({dense})}}),
                  Formats({{a, Format({dense})},
                           {B, Format({dense, sparse})},
                           {c, Format({dense})}}),
                  Formats({{a, Format({dense})},
                           {B, Format({sparse, dense})},
                           {c, Format({dense})}}),
                  Formats({{a, Format({dense})},
                           {B, Format({sparse, sparse})},
                           {c, Format({dense})}})),
              {TestCase({{B, {{{0, 0}, 42.0}, {{0, 2}, 2.0}, {{1, 1}, 3.0}, {{3, 3}, 4.0}}},
                         {c, {{{2}, 1.0}, {{3}, 2.0}}}},
                        {{a, {{{0}, 2.0}, {{3}, 8.0}}}})})
    ...
    TEST_STMT(broadcast_vector_add_scalar,
              ...
              {TestCase({{beta, {{{}, 42.0}}},
                         {c, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, 43.0}, {{1}, 42.0}, {{2}, 44.0}, {{3}, 42.0}, {{4}, 45.0}}}})})
    ...
    TEST_STMT(vector_exp,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::exp(1.0)}, {{1}, 1.0}, {{2}, std::exp(2.0)}, {{3}, 1.0}, {{4}, std::exp(3.0)}}}})})
    ...
    TEST_STMT(vector_product_exp,
              ...
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 4.0}}},
                         {c, {{{1}, 1.0}, {{2}, 3.0}, {{4}, 5.0}}}},
                        {{a, {{{0}, 1.0}, {{1}, 1.0}, {{2}, std::exp(6.0)}, {{3}, 1.0}, {{4}, std::exp(20.0)}}}})})
    ...
    TEST_STMT(vector_log,
              ...
              Values(
                  Formats({{a, dense}, {b, dense}}),
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{1}, 2.0}, {{2}, 3.0}, {{3}, 4.0}, {{4}, 5.0}}}},
                        {{a, {{{0}, 0.0}, {{1}, std::log(2.0)}, {{2}, std::log(3.0)}, {{3}, std::log(4.0)}, {{4}, std::log(5.0)}}}})})
    ...
    TEST_STMT(vector_log10,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{1}, 2.0}, {{2}, 3.0}, {{3}, 4.0}, {{4}, 5.0}}}},
                        {{a, {{{0}, 0.0}, {{1}, std::log10(2.0)}, {{2}, std::log10(3.0)}, {{3}, std::log10(4.0)}, {{4}, std::log10(5.0)}}}})})
    ...
    TEST_STMT(vector_sin,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::sin(1.0)}, {{2}, std::sin(2.0)}, {{4}, std::sin(3.0)}}}})})
    ...
    TEST_STMT(vector_cos,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::cos(1.0)}, {{1}, 1.0}, {{2}, std::cos(2.0)}, {{3}, 1.0}, {{4}, std::cos(3.0)}}}})})
    ...
    TEST_STMT(vector_tan,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::tan(1.0)}, {{2}, std::tan(2.0)}, {{4}, std::tan(3.0)}}}})})
    ...
    TEST_STMT(vector_asin,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::asin(1.0)}, {{2}, std::asin(2.0)}, {{4}, std::asin(3.0)}}}})})
    ...
    TEST_STMT(vector_acos,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::acos(1.0)}, {{1}, std::acos(0.0)}, {{2}, std::acos(2.0)}, {{3}, std::acos(0.0)}, {{4}, std::acos(3.0)}}}})})
    ...
    TEST_STMT(vector_atan,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::atan(1.0)}, {{2}, std::atan(2.0)}, {{4}, std::atan(3.0)}}}})})
    ...
    TEST_STMT(vector_atan2_constant,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, -2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::atan2(1.0, 5.0)}, {{2}, std::atan2(-2.0, 5.0)}, {{4}, std::atan2(3.0, 5.0)}}}})})
    ...
    TEST_STMT(vector_atan2_vector,
              ...
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 4.0}}},
                        ...
                        {{a, {{{0}, std::atan2(1.0, 0.0)}, {{1}, std::atan2(0.0, 2.0)}, {{2}, std::atan2(2.0, 3.0)}, {{3}, std::atan2(0.0, 3.0)}, {{4}, std::atan2(4.0, 5.0)}}}})})
    ...
    TEST_STMT(vector_sinh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::sinh(1.0)}, {{2}, std::sinh(2.0)}, {{4}, std::sinh(3.0)}}}})})
    ...
    TEST_STMT(vector_cosh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::cosh(1.0)}, {{1}, std::cosh(0.0)}, {{2}, std::cosh(2.0)}, {{3}, std::cosh(0.0)}, {{4}, std::cosh(3.0)}}}})})
    ...
    TEST_STMT(vector_tanh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::tanh(1.0)}, {{2}, std::tanh(2.0)}, {{4}, std::tanh(3.0)}}}})})
    ...
    TEST_STMT(vector_asinh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::asinh(1.0)}, {{2}, std::asinh(2.0)}, {{4}, std::asinh(3.0)}}}})})
    ...
    TEST_STMT(vector_acosh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::acosh(1.0)}, {{1}, std::acosh(0.0)}, {{2}, std::acosh(2.0)}, {{3}, std::acosh(0.0)}, {{4}, std::acosh(3.0)}}}})})
    ...
    TEST_STMT(vector_atanh,
              ...
              Values(
                  ...
                  Formats({{a, dense}, {b, sparse}})),
              {TestCase({{b, {{{0}, 1.0}, {{2}, 2.0}, {{4}, 3.0}}}},
                        {{a, {{{0}, std::atanh(1.0)}, {{2}, std::atanh(2.0)}, {{4}, std::atanh(3.0)}}}})})
    ...
    TEST_STMT(lowerSpecialRegions1,
              ...
              Values(
                  Formats({{A, Format({dense, dense})}, {B, Format({dense, dense})}, {C, Format({dense, dense})}, {D, Format({dense, dense})}}),
                  Formats({{A, Format({dense, sparse})}, {B, Format({dense, sparse})}, {C, Format({dense, sparse})}, {D, Format({dense, sparse})}}),
                  Formats({{A, Format({sparse, sparse})}, {B, Format({sparse, sparse})}, {C, Format({sparse, sparse})}, {D, Format({sparse, sparse})}})),
              {TestCase(
    ...
    TEST_STMT(lowerCompUnion,
              ...
              {TestCase(
                  ...
                  {{A, {{{0, 1}, 5.0}, {{1, 2}, 3.0}, {{2, 1}, 7.0}, {{2, 2}, 4.0}, {{3, 3}, 5.0}, {{4, 3}, 15.0}}}})})
    ...
    Func sparsify("sparsify", identityFunc(), [](const std::vector<IndexExpr> &v)
                  { return Union(v[0], Complement(v[1])); });
    ...
    TEST_STMT(XorTestOrder2,
              ...
              {TestCase(
                  ...
                  {{C, {{{1, 1}, 3.0}, {{1, 2}, 2.0}, {{1, 3}, 5.0}, {{2, 1}, 3.0}, {{2, 2}, 4.0}}}})})
